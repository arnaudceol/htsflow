...
function RecoverIDoptMerge($rm_dup = 0)
{
    global $con;
    $query = "SELECT id FROM pa_options WHERE rm_bad_reads = 0 AND trimming = 0 AND masking = 0 AND alignment = 0 AND paired = 0 AND rm_tmp_files = 0 AND rm_duplicates = " . $rm_dup . " ;";
...
$optID = RecoverIDoptMerge($rm_duplicates);

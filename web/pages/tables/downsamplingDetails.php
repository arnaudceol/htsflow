...
?><b>Downsampling from: </b><div class="table-container">
<?php
    ...
    <table class="mytable filterable" id="sf2" style="width: 100%;">
		...
		<tbody>
    <?php
    $sqlMerge = "SELECT source_primary_id, sample_id, sample_name, raw_reads_num, reads_num, user_name FROM downsample_primary, sample, primary_analysis, users WHERE sample_id = sample.id AND primary_analysis.id = source_primary_id AND users.user_id = sample.user_id AND result_primary_id = " . $queryPrimaryId;

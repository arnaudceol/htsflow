 ...
 */
?>
<form  style="display: inline-block;" name="CONTROL" action="" method="post">
	<!--	    // FILTERING OPTIONS-->
			...
			<tr>
				<th><b>Refine your search:</b></th>
					...
					<td><select name="level">
						...
						<option value="primary" <?php if (isset ( $_POST ['level'] ) && $_POST ['level'] == "primary") { echo "selected"; }?>>primary</option>
						<option value="secondary" <?php if (isset ( $_POST ['level'] ) && $_POST ['level'] == "secondary") { echo "selected"; }?>>secondary</option>
                        </select></td>
				<td><?php

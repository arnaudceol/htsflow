...
$querySpec = sprintf($querySpecPrepare, "expression_quantification", $row["id"]);
...
<tbody>
		...
		<td><?php echo $rowSpec["id"]; ?><a href="samples.php?sampleId=<?php echo $rowSpec["id"]; ?>"><i class="fa fa-reply"></i></a></td>

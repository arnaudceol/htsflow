...
$id = $_POST["ID"];
$subquery = "UPDATE secondary_analysis SET status='waiting to (re)start' WHERE id=" . $id . ";";
...
$sqlQuery = "insert into job_list (analyses_type , analyses_id , action , user_id ) values ('secondary', " . $id . ", 'run', " . $user_id . ") ";

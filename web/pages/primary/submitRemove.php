...
// if (isset ( $_POST ['submitDeletePrimary'] )) {
$id = $_POST["ID"];
$subquery = "UPDATE primary_analysis SET status='waiting to be deleted' WHERE id=" . $id . ";";
...
$sqlQuery = "insert into job_list (analyses_type , analyses_id , action , user_id ) values ('primary', " . $id . ", 'delete', " . $user_id . ") ";
